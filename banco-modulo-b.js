...
/* ══════════════════════════════════════════
  ...
  ══════════════════════════════════════════ */
  {
    ...
    venn:{ sets:["Curso A","Curso B"], regions:{A:120, AB:60, B:80}, outside:"Ninguno: 20", caption:"Cada región muestra los exclusivos: solo A = 180−60 = 120." },
...

{
  ...
  pt:"Diagrama de Venn con dos datos",
  venn:{ sets:["TV","Redes"], regions:{A:240, AB:80, B:130}, outside:"Ninguno: 50", caption:"Solo TV = 320−80 = 240 · Solo Redes = 210−80 = 130." },
...
},
{
  ...
  venn:{ sets:["Inglés","Francés"], regions:{A:100, AB:20, B:30}, outside:"Ninguno: 50", caption:"Inglés=120, Francés=50, ambos=20 → solo inglés=100, solo francés=30." },
...
/* ─────────  1.1 TEORÍA DE CONJUNTOS  (+4)  ───────── */
{
  ...
  venn:{ sets:["Excel","Word"], regions:{A:80, AB:50, B:40}, outside:"Ninguno: 30", caption:"Solo Excel = 130−50 = 80 · Solo Word = 90−50 = 40." },
...
},
{
  ...
  venn:{ sets:["Legal","Proced.","Atención"], regions:{A:30, B:30, C:20, AB:15, AC:10, BC:5, ABC:15}, caption:"Regiones exclusivas tras restar las intersecciones (centro = los tres = 15)." },
