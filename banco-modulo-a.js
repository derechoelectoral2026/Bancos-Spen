...
//  Versión: 1.1
//  Total: 115 preguntas · 5 subáreas · 4 formatos
//  (85 originales + 30 reactivos extra v1.1)
//
...
{
  id:86, sub:"1.1", label:"Comprensión lectora – Ámbito de estudio", fmt:"A",
  pTitle:"La Hipótesis Nula",
  passage:"En estadística inferencial, la hipótesis nula (H0) postula que no existe efecto o diferencia entre los grupos comparados. El investigador no busca 'demostrar' la hipótesis nula, sino acumular evidencia suficiente para rechazarla. Cuando los datos no permiten rechazarla, la conclusión correcta no es que la H0 sea verdadera, sino que la evidencia disponible es insuficiente para descartarla.",
  q:"Según el texto, ¿cuál es la conclusión correcta cuando los datos no permiten rechazar la hipótesis nula?",
  opts:["Que la hipótesis nula ha quedado científicamente demostrada como verdadera.","Que la evidencia disponible es insuficiente para descartarla, no que sea cierta.","Que el diseño experimental fue defectuoso y debe repetirse el estudio."],
  correct:1, expl:"El texto distingue explícitamente entre 'no rechazar' y 'demostrar'; la falta de evidencia para rechazar no equivale a probar la H0."
},
{
  id:87, sub:"1.1", label:"Comprensión lectora – Ámbito de estudio", fmt:"B",
  pTitle:"Muestreo Probabilístico y No Probabilístico",
  passage:"En el muestreo probabilístico cada elemento de la población tiene una probabilidad conocida y distinta de cero de ser seleccionado, lo que permite estimar el error muestral y generalizar resultados. En el muestreo no probabilístico la selección depende del juicio del investigador o de la disponibilidad de los sujetos, por lo que sus hallazgos no son estadísticamente generalizables.",
  q:"Según el fragmento, la principal limitación del muestreo no probabilístico es que sus resultados no son ________ a la población de origen mediante inferencia estadística.",
  opts:["aplicables ni interpretables","generalizables ni proyectables","registrables ni publicables"],
  correct:1, expl:"El texto afirma que los hallazgos no son 'estadísticamente generalizables' porque la probabilidad de selección no es conocida."
},
{
  id:88, sub:"1.1", label:"Comprensión lectora – Ámbito de estudio", fmt:"D",
  pTitle:"Tipos de Variables en Investigación",
  passage:"En el diseño metodológico, las variables se clasifican según el rol que cumplen en la relación causal que se estudia. Identificarlas con precisión es condición necesaria para el análisis estadístico posterior.",
  q:"Relaciona cada tipo de variable con su definición operativa.",
  leftItems:["Variable independiente","Variable dependiente","Variable moderadora"],
  rightItems:["Modifica la fuerza o dirección de la relación entre otras dos variables","Es manipulada o categorizada por el investigador como posible causa","Es el efecto observado o medido como resultado del estudio"],
  correctPairs:[[0,1],[1,2],[2,0]],
  expl:"Independiente = causa manipulada; Dependiente = efecto medido; Moderadora = altera la relación entre las dos anteriores."
},
{
  id:89, sub:"1.1", label:"Comprensión lectora – Ámbito de estudio", fmt:"C",
  pTitle:"Construcción de un Estado del Arte",
  passage:"El estado del arte es la sección que sintetiza qué se ha investigado previamente sobre un problema y qué vacíos persisten. Su elaboración requiere un proceso ordenado de revisión documental.",
  q:"Ordena las fases para construir un estado del arte de la primera a la última.",
  items:["Identificación de vacíos y formulación del aporte propio","Definición de criterios de inclusión y exclusión de fuentes","Análisis crítico y categorización temática de hallazgos","Búsqueda sistemática en bases de datos académicas"],
  correctOrder:[1,3,2,0],
  expl:"El orden lógico es: definir criterios → buscar en bases de datos → analizar y categorizar → identificar vacíos y aporte propio."
},
{
  id:90, sub:"1.1", label:"Comprensión lectora – Ámbito de estudio", fmt:"A",
  pTitle:"Plagio Académico y Paráfrasis",
  passage:"El plagio académico no se limita a copiar textualmente sin comillas ni cita: también incluye la paráfrasis insuficiente, en la que se cambian unas pocas palabras pero se conserva la estructura sintáctica y el orden de las ideas del original. La paráfrasis legítima exige reformular completamente la idea con vocabulario y estructura propios, manteniendo la atribución a la fuente.",
  q:"¿Cuál es la diferencia esencial entre paráfrasis legítima y paráfrasis insuficiente según el fragmento?",
  opts:["La paráfrasis legítima omite la cita; la insuficiente la conserva.","La paráfrasis legítima reformula completamente con estructura propia; la insuficiente solo cambia palabras manteniendo el orden original.","La paráfrasis legítima copia textualmente entre comillas; la insuficiente nunca usa comillas."],
  correct:1, expl:"El texto define la paráfrasis insuficiente como aquella que 'cambia unas pocas palabras pero conserva la estructura sintáctica y el orden de las ideas'; la legítima reformula por completo."
},
{
  id:91, sub:"1.1", label:"Comprensión lectora – Ámbito de estudio", fmt:"B",
  pTitle:"Triangulación Metodológica",
  passage:"La triangulación consiste en abordar un mismo objeto de estudio desde múltiples fuentes, métodos o investigadores con el fin de aumentar la solidez de los hallazgos. Cuando los resultados obtenidos por distintas vías convergen, la confianza en la conclusión se refuerza; cuando divergen, el investigador queda obligado a explicar la discrepancia.",
  q:"Según el texto, cuando los resultados de la triangulación divergen, el investigador debe ________ la inconsistencia, en vez de ignorarla.",
  opts:["explicar y dar cuenta de","ocultar y minimizar","suprimir y descartar"],
  correct:0, expl:"El texto señala que la divergencia 'obliga al investigador a explicar la discrepancia'; no la convierte en motivo para descartar datos."
},

// ───── 1.2 Comprensión lectora – Ámbito literario (+6) ─────
{
  id:92, sub:"1.2", label:"Comprensión lectora – Ámbito literario", fmt:"A",
  pTitle:"El Realismo Mágico",
  passage:"El realismo mágico no consiste en introducir hechos sobrenaturales como fantasía, sino en presentar lo extraordinario como parte natural de la realidad cotidiana, sin que los personajes ni el narrador manifiesten asombro. Esta naturalización es lo que distingue a la corriente del género fantástico tradicional, en el que lo sobrenatural irrumpe como ruptura del orden conocido.",
  q:"¿Qué distingue al realismo mágico del género fantástico tradicional según el fragmento?",
  opts:["El realismo mágico evita por completo cualquier hecho sobrenatural en la trama.","El realismo mágico naturaliza lo extraordinario sin ruptura del orden cotidiano; el fantástico lo presenta como irrupción.","El realismo mágico se ambienta exclusivamente en escenarios urbanos contemporáneos."],
  correct:1, expl:"El texto define la diferencia clave: en el realismo mágico lo sobrenatural se naturaliza, no genera asombro; en el fantástico irrumpe rompiendo lo cotidiano."
},
{
  id:93, sub:"1.2", label:"Comprensión lectora – Ámbito literario", fmt:"B",
  pTitle:"El Soliloquio Teatral",
  passage:"El soliloquio es un recurso por el cual un personaje, solo en escena, expresa en voz alta sus pensamientos íntimos. A diferencia del aparte, dirigido al público de manera momentánea, el soliloquio constituye una pausa reflexiva extensa que revela la conciencia del personaje y suele preceder a una decisión decisiva en la trama.",
  q:"Según el texto, el soliloquio se diferencia del aparte porque es una pausa ________ que revela la interioridad del personaje y antecede una decisión.",
  opts:["breve y momentánea","reflexiva y extensa","colectiva y compartida"],
  correct:1, expl:"El texto contrapone el aparte (momentáneo) con el soliloquio, definido como 'pausa reflexiva extensa'."
},
{
  id:94, sub:"1.2", label:"Comprensión lectora – Ámbito literario", fmt:"D",
  pTitle:"Tipos de Narrador según el Punto de Vista",
  passage:"La elección del narrador determina qué información llega al lector y desde qué perspectiva. Cada tipo produce efectos distintos sobre la cercanía emocional y la fiabilidad de los hechos relatados.",
  q:"Relaciona cada tipo de narrador con su característica.",
  leftItems:["Narrador omnisciente","Narrador protagonista","Narrador testigo"],
  rightItems:["Cuenta en primera persona los hechos que vivió otro personaje al que observa","Conoce los pensamientos y emociones de todos los personajes y los hechos pasados y futuros","Relata en primera persona su propia experiencia desde su perspectiva limitada"],
  correctPairs:[[0,1],[1,2],[2,0]],
  expl:"Omnisciente = lo sabe todo; Protagonista = primera persona viviendo los hechos; Testigo = primera persona observando a otro."
},
{
  id:95, sub:"1.2", label:"Comprensión lectora – Ámbito literario", fmt:"C",
  pTitle:"Etapas de la Tragedia Clásica",
  passage:"La estructura de la tragedia clásica griega, fijada por Aristóteles, sigue una progresión que conduce inevitablemente a la catástrofe del héroe a partir de un error de juicio.",
  q:"Ordena las fases de la tragedia clásica de la primera a la última.",
  items:["Catástrofe: desenlace doloroso del héroe","Hybris: desmesura o error trágico del protagonista","Anagnórisis: reconocimiento que el héroe hace de la verdad","Peripecia: cambio súbito de la fortuna del héroe"],
  correctOrder:[1,3,2,0],
  expl:"Aristóteles ordena: Hybris (error inicial) → Peripecia (cambio de fortuna) → Anagnórisis (reconocimiento) → Catástrofe (desenlace doloroso)."
},
{
  id:96, sub:"1.2", label:"Comprensión lectora – Ámbito literario", fmt:"A",
  pTitle:"La Metaficción",
  passage:"La metaficción es la literatura que reflexiona sobre sí misma, exhibiendo abiertamente su condición de artificio. El narrador interrumpe la trama para comentar el proceso de escritura, los personajes saben que son personajes, o el texto cuestiona las convenciones del género que está usando. Su efecto es romper la ilusión realista y hacer al lector consciente de que lee una construcción.",
  q:"¿Cuál es el efecto principal de la metaficción según el fragmento?",
  opts:["Reforzar la ilusión realista para que el lector se identifique con los personajes.","Romper la ilusión realista exhibiendo el carácter construido de la obra.","Eliminar al narrador para que la trama avance por sí sola sin mediaciones."],
  correct:1, expl:"El texto afirma que la metaficción 'rompe la ilusión realista y hace al lector consciente de que lee una construcción'."
},
{
  id:97, sub:"1.2", label:"Comprensión lectora – Ámbito literario", fmt:"B",
  pTitle:"El Verso Libre",
  passage:"El verso libre se desliga de las exigencias métricas tradicionales —medida silábica regular y rima— y construye su ritmo a partir de otros recursos: la disposición visual en la página, las pausas, las repeticiones y los paralelismos sintácticos. La libertad formal no implica ausencia de ritmo, sino una nueva manera de producirlo.",
  q:"Según el texto, en el verso libre el ritmo no desaparece, sino que se produce mediante recursos como las pausas, las repeticiones y los ________ sintácticos.",
  opts:["sinónimos y antónimos","paralelismos","tiempos verbales"],
  correct:1, expl:"El texto enumera entre los recursos rítmicos del verso libre 'las repeticiones y los paralelismos sintácticos'."
},

// ───── 1.3 Comprensión lectora – Ámbito de participación social (+3) ─────
{
  id:98, sub:"1.3", label:"Comprensión lectora – Ámbito de participación social", fmt:"A",
  pTitle:"Burbujas de Filtro y Algoritmos",
  passage:"Las burbujas de filtro son entornos informativos personalizados por algoritmos que muestran a cada usuario contenidos afines a sus preferencias previas y ocultan los que probablemente no aprobaría. El efecto a largo plazo es la reducción de la exposición a perspectivas diversas y el reforzamiento de las propias creencias, lo que erosiona el debate público basado en un mismo conjunto de hechos compartidos.",
  q:"¿Cuál es el principal riesgo democrático de las burbujas de filtro descrito en el texto?",
  opts:["La saturación informativa que impide a los usuarios procesar tanta variedad de contenido.","La erosión del debate público al reducir la exposición a perspectivas diversas y los hechos compartidos.","La pérdida de privacidad ante la recolección masiva de datos personales por las plataformas."],
  correct:1, expl:"El texto plantea como efecto central que las burbujas 'erosionan el debate público basado en hechos compartidos' al reducir la diversidad de perspectivas; la privacidad no es el eje del fragmento."
},
{
  id:99, sub:"1.3", label:"Comprensión lectora – Ámbito de participación social", fmt:"D",
  pTitle:"Principios Rectores de la Función Electoral",
  passage:"En México, la función electoral se rige por una serie de principios constitucionales que orientan la actuación de las autoridades electorales y dan legitimidad al proceso democrático.",
  q:"Relaciona cada principio rector electoral con su definición.",
  leftItems:["Imparcialidad","Independencia","Máxima publicidad"],
  rightItems:["Toda la información en posesión de la autoridad electoral es pública, salvo excepciones","La autoridad ejerce sus atribuciones sin sujeción a intereses externos a la función","La autoridad actúa sin favorecer a ninguna fuerza política o aspirante"],
  correctPairs:[[0,2],[1,1],[2,0]],
  expl:"Imparcialidad = no favorecer fuerzas políticas; Independencia = sin sujeción a intereses externos; Máxima publicidad = información pública por defecto."
},
{
  id:100, sub:"1.3", label:"Comprensión lectora – Ámbito de participación social", fmt:"B",
  pTitle:"Paridad de Género en Cargos de Elección",
  passage:"El principio de paridad establece que los cargos de elección popular deben distribuirse en proporciones iguales entre mujeres y hombres. No se trata únicamente de postular el mismo número de candidaturas, sino de asegurar que esa paridad se traduzca en ocupación efectiva de cargos, evitando que las mujeres queden concentradas en distritos perdedores o en suplencias.",
  q:"Según el texto, garantizar paridad sustantiva implica asegurar la ocupación ________ de cargos por mujeres, no solo postular candidaturas en cantidad equivalente.",
  opts:["formal y nominal","efectiva y real","provisional y temporal"],
  correct:1, expl:"El texto distingue entre el conteo de candidaturas y la 'ocupación efectiva de cargos', evitando que la paridad sea solo nominal."
},
